function [V_opt, A_opt, B_opt, A_c_opt, B_c_opt, obj_prev, status] =sca_feasible_pbf(para,w_k,channel_data,decoding_order,...
    A_prev, B_prev, A_c_prev, B_c_prev,alpha,J_r,J_t)
    % Parameters
    K   = para.K;
    K_c = para.K_c;
    N   = para.N;
   ...
   cvx_begin quiet 
        ...
        subject to
                ...
                for k = 1:K
                    V + delta_g * eye(N) == hermitian_semidefinite(N);
                end
